...
export let BHorizontalContainer = (_dec = customElement('b-horizontal-container'), _dec2 = containerless(), _dec(_class = _dec2(_class = (_class2 = (_temp = _class3 = class BHorizontalContainer {
