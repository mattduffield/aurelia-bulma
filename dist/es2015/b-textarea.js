...
export let BTextarea = (_dec = customElement('b-textarea'), _dec2 = inject(Element), _dec3 = containerless(), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = class BTextarea {
