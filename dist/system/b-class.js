...
System.register(['aurelia-framework'], function (_export, _context) {
  ...
  var customAttribute, bindable, _typeof, _dec, _class, _desc, _value, _class2, _descriptor, _class3, _temp, BClass;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('BClass', BClass = (_dec = customAttribute('b-class'), _dec(_class = (_class2 = (_temp = _class3 = function () {
