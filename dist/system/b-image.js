...
System.register(['aurelia-framework'], function (_export, _context) {
  ...
  var customElement, bindable, _dec, _class, _desc, _value, _class2, _descriptor, _descriptor2, _class3, _temp, BImage;
  ...
  return {
    ...
    execute: function () {
      _export('BImage', BImage = (_dec = customElement('b-image'), _dec(_class = (_class2 = (_temp = _class3 = function BImage(element) {
