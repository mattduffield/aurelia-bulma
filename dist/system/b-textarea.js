...
System.register(['aurelia-framework'], function (_export, _context) {
  ...
  var inject, customElement, containerless, bindable, _createClass, _dec, _dec2, _dec3, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, TextareaID, BTextarea;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('BTextarea', BTextarea = (_dec = customElement('b-textarea'), _dec2 = inject(Element), _dec3 = containerless(), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = function () {
        function BTextarea(element) {
          _classCallCheck(this, BTextarea);
